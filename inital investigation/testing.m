...
collision_tolerance = 20e3; %m, the border around objects to assume no collision
...
for n=1:2
    ...
    sim_time = abs(total_transit_statematrix(:,1)-total_transit_statematrix(1,1))/(3600*24);
    trail_patch = patch([total_transit_statematrix(:,2); nan],[total_transit_statematrix(:,3); nan],[total_transit_statematrix(:,4); nan], [sim_time; nan],'EdgeColor','interp', 'LineWidth', 2);
